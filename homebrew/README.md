...
- Recipe `install-homebrew` installs it directly
- Recipe `install-homebrew-packages` installs the [bundle](https://docs.brew.sh/Brew-Bundle-and-Brewfile) of packages specified in: [`homebrew/homebrew.dep`](./homebrew/homebrew.dep)
