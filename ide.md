...
Before you run the script, inspect the extensions that it will install. To maintain workstation integrity, only install extensions from reputable & verified authors, that regularly address issues with code updates.
