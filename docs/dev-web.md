# <figure style="float: right; margin: 0.3ex 0.5em; line-height: 1; text-align: center; font-size: 80px">🌐</figure> Web development
...
- ⚙ **Use a modern build tool:** Don't use legacy `create-react-app` but scaffold your project with **[Vite+](./viteplus.md)** instead. It's significantly faster and simpler to configure.
