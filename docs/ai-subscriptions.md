...
> **Privacy & Data Usage:** Before subscribing, be aware that many consumer-grade plans (like ChatGPT Plus, Claude Pro, or Google One AI Premium) may use your queries and code for model training by default. If you are handling sensitive intellectual property or trade secrets, you may prefer API-based billing or Enterprise tiers, which typically offer stronger privacy guarantees and "opt-out" defaults. See [Privacy & IP Protection](./ai-quickstart.md#privacy--ip-protection) for more details.
