# <img src="https://cdn.simpleicons.org/rust" alt="Rust logo" align="right" width="96" style="width: 96px; max-height: 96px; margin-top: -27px;"> Rust
...
- ⚙️ [Rustup](https://rustup.rs/) will install the default toolchain specified in _your_ `~/.rustup/settings.toml` _if it exists._
